...
public class FolderStructureAnimationImporter : EditorWindow
{
    ...
    private readonly Dictionary<string, Vector2> directionPositions = new Dictionary<string, Vector2>() {
        ...
        { "LeftBottom", new Vector2(-0.866f, -0.5f) },
        { "RightBottom", new Vector2(0.866f, -0.5f) },
        { "Left", new Vector2(-1, 0) },
        { "BottomLeft", new Vector2(-0.5f, -0.866f) },
        { "TopLeft", new Vector2(-0.5f, 0.866f) },
        { "Right", new Vector2(1, 0) },
        { "BottomRight", new Vector2(0.5f, -0.866f) },
        { "TopRight", new Vector2(0.5f, 0.866f) },
        { "Top", new Vector2(0, 1) },
        { "LeftTop", new Vector2(-0.866f, 0.5f) },
        { "RightTop", new Vector2(0.866f, 0.5f) }
    };
